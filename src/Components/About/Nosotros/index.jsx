...
const img = 'https://www.elpaisano.pe/wp-content/uploads/2021/09/Programa-Mi-Juntos-1.jpg'
...
const Nosotros = () => {
    ...
    return (
        <>
            ...
            <main>
                <h3 className={s["title_sobre_nosotros"]}>Les presentamos a Nuestro equipo!</h3>
                <MembersList />
                <h3 className={s["title_sobre_nosotros"]}>Nuestra historia</h3>
                <p className={s["sobre_nosotros"]}>
                    {textoParaMostrar}
                </p>
            </main>
        </>
