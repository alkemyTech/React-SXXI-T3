...
export const TestimonialsList = () => {
  const mockedData = [
    ...
    },
    {
      ...
      description:
        "<p>Somos Más es una organizacion benéfica que aporta mucho a la sociedad.&nbsp;</p>",
    ...
    },
    {
      ...
      description:
        "La sonrisa de los niños y los abrazos se convirtieron en la recompensa mas valiosa de mis días. Gracias Somos Más por permitirme formar parte de su ONG.",
    ...
    },
    {
      ...
      description:
        "Me parece que no hay nada más gratificante que ver a los niños reir y felcices, disfrutando su inocencia. Esto es una de las tantas cosas que logra Somos Más con sus iniciativas",
    ...
    },
    {
      ...
      description:
        "Fue muy impactante ver la gran necesidad que sufren algunas familias, dentro de estas muchos niños y adolescentes, por suerte existen organizaciones como estas para brindar un rayo de sol",
    ...
    },
    {
      ...
      description:
        "Me enamoré de las mascotas al tener que participar en el programa donde se hacian participar a los jóvenes en el cuidado de animales abandonados.",
    ...
    },
    {
      ...
      description:
        "En las jornadas de fútbol, muchos jóvenes se veían motivados y empezaban a ver el deporte como una posible carrera profesional, Somos Más abre la mente de los chichos.",
    ...
    },
    {
      ...
      description:
        "Ni tirar el anillo en el monte del destino me dio mas satisfacciones que aportar a Somos más. Sus campañas son excelentes.",
    ...
    },
    {
      ...
      description:
        "Ver la sonrisa de esos niños es el tesoro más grande que cualquiera puede encontrar. Mas que agradecido de haber participado en las iniciativas que llevan a cabo.",
    ...
    },
    {
      ...
      description:
        "Es emocionante poder ser parte del desarrollo de las infancias y adolescencias, que se lleven cosas valiosas y sobretodo anecdotas felices.",
    ...
    },
    {
      ...
      description:
        "La jornada del sábado 15 de febrero fue hermosa, y la volvería a repetir.",
    ...
    },
    {
      ...
      description:
        "Desde SpaceX nos enorgullecemos de participar en todas las iniciativas de Somos Más. Cada jornada es inolvidable",
    ...
    },
    {
      ...
      description:
        "Desde el School for Gifted Youngsters celebramos toda el entusiasmo \ne impetu con el que esta ONG lleva adelante sus propuestas.",
  ...
  const deleteTestimonialHandler = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        Swal.fire("Testimonio borrado!", "", "success");
      }
    });
  };
